...
#define STRING_CONFIG_H_AUTHOR "(Kizokumaru, Geeetech i3 pro b bltouch)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  15.88 //M303 E0 S200 C8 - Obtenidos mediante PID Autotune
    #define DEFAULT_Ki   0.77
    #define DEFAULT_Kd  82.29
  #endif
#endif // PIDTEMP
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.0203, 80.0203, 400, 105}  
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -1.1, -49.6, -4.00 }
